...
namespace Maptz
{
    ...
    /// 
    /// NOTE This is adapted from the microsoft TimeCode source code found here: https://code.msdn.microsoft.com/silverlight/MMP-Video-Editor-472a92fe/sourcecode?fileId=97251&pathId=731055340
    /// </remarks>
    [JsonConverter(typeof(TimeCodeSerializer))]
    public partial struct TimeCode : IComparable, IComparable<TimeCode>, IEquatable<TimeCode>, ITimeCode
    {
        #region Private Fields
        /// <summary>
        /// The private Timespan used to track absolute time for this instance in seconds.
        /// </summary>
        ...
        public int DaysSegment
        {
            get
            {
                string timeCode = AbsoluteTimeToSmpte12M(this._absoluteTime, this._frameRate);
        ...
        {
            get { return Convert.ToDouble(this._absoluteTime); }
        }
        ...
        public decimal AbsoluteTime { get { return this._absoluteTime; } set { this._absoluteTime = value; } }
        ...
        public double TotalDays
        {
            get
            {
                long framecount = AbsoluteTimeToFrames(this._absoluteTime, this._frameRate);
        ...
        public long TotalFrames
        {
            get
            {
                return AbsoluteTimeToFrames(this._absoluteTime, this._frameRate);
            }
        }
        ...
        public double TotalSeconds
        {
            get
            {
                return Convert.ToDouble(Math.Round(this._absoluteTime, 6));
            }
        }
        ...
        public TimeCode(int hours, int minutes, int seconds, int frames, SmpteFrameRate rate)
        {
            ...
            this._absoluteTime = Smpte12mToAbsoluteTime(timeCode, this._frameRate);
        }
        ...
        {
            this._frameRate = rate;
            this._absoluteTime = TimeCode.FromTimeSpan(timeSpan, rate)._absoluteTime;
        }
        ...
        public TimeCode(string timeCodeAndRate)
        {
            ...
            this._frameRate = SmpteFrameRate.Smpte2997NonDrop;

            if (rate == "29.97" && time.IndexOf(';') > -1)
            {
                this._frameRate = SmpteFrameRate.Smpte2997Drop;
            }
            ...
            {
                this._frameRate = SmpteFrameRate.Smpte25;
            }
            else if (rate == "23.98")
            {
                this._frameRate = SmpteFrameRate.Smpte2398;
            }
            else if (rate == "24")
            {
                this._frameRate = SmpteFrameRate.Smpte24;
            }
            else if (rate == "30")
            {
                this._frameRate = SmpteFrameRate.Smpte30;
            }

            this._absoluteTime = Smpte12mToAbsoluteTime(time, this._frameRate);
        }
        ...
        {
            this._absoluteTime = Convert.ToDecimal(absoluteTime);
            this._frameRate = rate;
        }
        ...
        {
            this._absoluteTime = Ticks27MhzToAbsoluteTime(ticks27Mhz);
            this._frameRate = rate;
        }
        ...
        private static long AbsoluteTimeToFrames(decimal absoluteTime, SmpteFrameRate rate)
        {
            ...
            {
                return Convert.ToInt64(decimal.Floor(Math.Round((decimal)(24 * (float)(1000 / 1001M) * (float)(absoluteTime + EPSILON)), 25)));
            }
            ...
            {
                return Convert.ToInt64(decimal.Floor(Math.Round((decimal)(30 * (float)(1000 / 1001M) * (float)(absoluteTime + EPSILON)), 25)));
            }
        ...
        private static double FramesToAbsoluteTime(long frames, SmpteFrameRate rate)
        {
            ...
            if (rate == SmpteFrameRate.Smpte2398)
            {
                absoluteTimeInDecimal = frames / 24M / Math.Round((1000 / 1001M), 11);
            }
            else if (rate == SmpteFrameRate.Smpte24)
            {
            ...
            {
                absoluteTimeInDecimal = frames / 30M / Math.Round((1000 / 1001M), 11);
            }
            else if (rate == SmpteFrameRate.Smpte30)
            {
        ...
        {
            return AbsoluteTimeToSmpte12M(this._absoluteTime, this._frameRate);
        }
        ...
        {
            return AbsoluteTimeToSmpte12M(this._absoluteTime, rate);
        }
        ...
        {
            return AbsoluteTimeToTicks27Mhz(this._absoluteTime);
        }
        ...
        {
            return AbsoluteTimeToTicksPcrTb(this._absoluteTime);
        }
